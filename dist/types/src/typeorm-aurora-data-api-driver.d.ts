...
declare const createMysqlDriver: (region: string, secretArn: string, resourceArn: string, database: string, loggerFn?: (query: string, parameters?: any[]) => void, serviceConfigOptions?: any, formatOptions?: any) => DataApiDriver;
export default createMysqlDriver;
export declare const pg: (region: string, secretArn: string, resourceArn: string, database: string, loggerFn?: (query: string, parameters?: any[]) => void, serviceConfigOptions?: any, formatOptions?: any) => DataApiDriver;
